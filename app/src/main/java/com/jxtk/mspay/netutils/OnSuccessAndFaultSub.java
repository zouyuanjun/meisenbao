    ...
    public void onError(Throwable e) {
        try {
            ...
            if (e instanceof SocketTimeoutException) {//请求超时
                ...
                mOnSuccessAndFaultListener.onFault("错误"+e.getMessage());
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        } finally {
            Log.e("OnSuccessAndFaultSub", "error:" + e.getMessage());
        //     mOnSuccessAndFaultListener.onFault("连接网络失败，请检查网络或稍后再试");
            dismissProgressDialog();
            progressDialog = null;
...
//            String by=body.bytes().toString();
//            String sa=body.byteStream().toString();
//
//            Log.e("str",str);
//            Log.e("by",by);
//            Log.e("sa",sa);
        ...
        //    String result=body.string();
          ...
          //  Log.e("result", result);
            ...
            if (resultCode==200) {
                ...
                Log.e("OnSuccessAndFaultSub", "异常: " + errorMsg);
            }
        } catch (Exception e) {
            e.printStackTrace();
            mOnSuccessAndFaultListener.onFault(e.toString());
        }
    }
