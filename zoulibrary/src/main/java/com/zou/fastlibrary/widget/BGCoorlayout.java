...
public class BGCoorlayout extends ConstraintLayout {
    int strokecolor;
    float strokesize;
    float mRadius;
    int bgdividecolor;
    ...
    public BGCoorlayout(Context context) {
        super(context);
    }

    public BGCoorlayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initview(context,attrs);
    }

    public BGCoorlayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
